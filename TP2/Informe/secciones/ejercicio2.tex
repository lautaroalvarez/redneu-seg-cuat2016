...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\columnwidth]{graficos/kohonen/mapa1010.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\columnwidth]{graficos/kohonen/mapa2020.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\columnwidth]{graficos/kohonen/mapa3030.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaentrenamiento50.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaaciertos50.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaerrores50.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaindefinidas50.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/mapaentrenamiento200.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaaciertos200.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaerrores200.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaindefinidas200.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaentrenamiento800.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaaciertos800.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaerrores800.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaindefinidas800.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaentrenamientomejor.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaaciertosmejor.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaerroresmejor.png}
  \caption{Mapa de Errores para 800 entradas.}
  \label{fig:mapa errores 800}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{graficos/kohonen/mapaindefinidasmejor.png}
